...
/**
 * Ilovani QURILMANING O'ZIDAN yangilash — tsd-app `Updater.kt` bilan aynan
 * bir naqsh, faqat kanal `/downloads/menejer/` (nginx statikasi, tokensiz).
 *
 * 🔴 **SHA-256 MAJBURIY.** Yuklab olingan fayl manifestdagi xesh bilan
 * solishtiriladi va mos kelmasa O'RNATILMAYDI (yarim yuklangan APK
 * «buzilgan paket» xatosini berardi).
 */
class Updater(private val context: Context) {
    ...
    /** Manifestni o'qiydi. Tarmoq yo'q / buzuq bo'lsa `null` — ish to'xtamaydi. */
    ...
    /**
     * O'rnatuvchini ochadi. Android 8+ da «noma'lum manbalardan o'rnatish»
     * huquqi yo'q bo'lsa AYNAN o'sha sozlama ekraniga olib boradi.
     *
